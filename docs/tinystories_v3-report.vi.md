...
> **Ghi chú:** Đây là báo cáo của dự án đồng hành **tinystories_v3**, được port vào `tinystory-vn` (chỉ tài liệu). Toàn bộ **code, ADR, test và notebook** được nhắc tới nằm ở repo gốc: https://github.com/harryct229/tinystories_v3 — các đường dẫn tương đối như `src/`, `docs/adr/`, `tests/`, `notebooks/` là của repo đó. Bản tiếng Anh: [`tinystories_v3-report.md`](tinystories_v3-report.md) · bản HTML: [`tinystories_v3-report.vi.html`](tinystories_v3-report.vi.html).
