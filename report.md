---
title: "Đánh giá thực nghiệm các mô hình sinh truyện ngụ ngôn theo yêu cầu"
subtitle: "So sánh năm hệ thống được xây dựng độc lập trên cùng một quy trình đánh giá"
...
**Mục tiêu.** Nghiên cứu đánh giá các cách xây dựng hệ thống sinh truyện ngụ ngôn tiếng
Anh theo yêu cầu, có thể chạy cục bộ và đáp ứng năm trường đầu vào: nhân vật, bối cảnh,
thử thách, kết quả và bài học đạo đức.

**Phương pháp.** Nghiên cứu khảo sát ba nhóm phương pháp: (i) tiền huấn luyện mô hình
từ trạng thái khởi tạo ngẫu nhiên; (ii) PEFT/QLoRA trên mô hình đã tiền huấn luyện; và
(iii) kiểm soát đầu ra bằng kiểm tra hợp lệ, hậu xử lý và sửa lỗi theo điều kiện. Trong
từng hướng, kết quả đánh giá nội bộ chỉ dùng để chọn cấu hình đại diện; không dùng để
so sánh giữa các hướng vì tập đề và giám khảo khác nhau. Năm hệ thống đại diện sau đó
được chạy trên cùng 25 đề, tạo ra 125 truyện và được chấm mù bằng
`gemma-4-26b-a4b-it`. Ba thí nghiệm loại trừ, không huấn luyện lại, đo độ phủ điều
kiện, **counterfactual sensitivity** (mức độ đầu ra thay đổi đúng hướng khi chỉ thay
đổi một điều kiện) và đóng góp của bước sửa lỗi.

**Kết quả.** Quy trình đánh giá chung cho thấy hai nhóm kết quả rõ rệt: E4 đạt 9,20/10
và E5 đạt 8,44/10, trong khi E1–E3 nằm trong khoảng 2,81–3,30. Tuy nhiên, chênh lệch
điểm tổng hợp không thể quy trực tiếp cho số tham số, vì năm hệ thống còn khác nhau ở
dữ liệu tiền huấn luyện, giao diện điều kiện, kỹ thuật tinh chỉnh và hậu xử lý. Các thí
nghiệm loại trừ cho thấy nguyên nhân cụ thể hơn. Khi tăng số trường đầu vào từ hai lên
năm, E5 tăng độ phủ lên 3,68/5 và điểm nhất quán với chuỗi sự kiện được yêu cầu lên
7,28/10. E1 chỉ tăng độ phủ 0,44/5 và vẫn ở gần mức sàn; điểm nhất quán nội tại gần
như không đổi. Điều này cho thấy mô hình có thể tạo ra một câu chuyện tự nó hợp lý
nhưng không thực sự dùng đề bài. Trong 10 cặp counterfactual, E5 điều chỉnh lựa chọn
hoặc cách giải quyết phù hợp với thay đổi về tính cách hay kết quả ở cả 10 cặp, so với
1/10 của E1. Với E4, repair đưa tỷ lệ bài học đúng nguyên văn từ 20% lên 100% và tăng
điểm nhất quán theo yêu cầu từ 9,00 lên 9,64, nhưng không làm thay đổi hai liên kết
trait→choice (92%) và choice→outcome (100%). Như vậy, mối quan hệ giữa điều kiện và
diễn biến đã có trong đầu ra thô; repair chủ yếu sửa định dạng đầu ra và các sai lệch
cục bộ.

**Kết luận.** Đóng góp chính của nghiên cứu không phải là kết luận đơn giản rằng mô hình
lớn hơn sẽ đạt điểm cao hơn. Quan trọng hơn, nghiên cứu phân biệt ba mức độ tuân thủ:
nhắc lại trường đầu vào, tổ chức diễn biến phù hợp với toàn bộ điều kiện, và thay đổi
diễn biến đúng hướng khi một điều kiện bị can thiệp. Độ trôi chảy, loss và tính hợp lý
nội tại chỉ đo chất lượng bề mặt, không thể thay thế ba phép kiểm tra này. Trong phạm
vi thí nghiệm, E5 cung cấp bằng chứng mạnh nhất về khả năng kết hợp các điều kiện ngay
trong một lượt sinh; E4 cho thấy validator/repair có thể tăng độ tin cậy của đầu ra khi
nội dung gốc đã đúng về mặt ngữ nghĩa. Hai kết quả này dẫn đến hai ưu tiên thiết kế khác
nhau: nếu truyện chưa dùng điều kiện để chi phối diễn biến, cần cải thiện mô hình, dữ
liệu hoặc mục tiêu huấn luyện theo điều kiện; nếu diễn biến đã đúng nhưng định dạng và
bài học chưa ổn định, repair là lớp kiểm soát phù hợp. Kết luận này chỉ áp dụng cho tập
kiểm thử hiện tại và chưa cho phép xác định một ngưỡng tham số có tính phổ quát cho năng
lực suy luận nhân quả.

## 1. Giới thiệu

### 1.1 Mục tiêu và câu hỏi nghiên cứu

Mục tiêu của nghiên cứu là xác định biện pháp can thiệp nào cải thiện chất lượng và mức
độ tuân thủ điều kiện của mô hình sinh truyện ngụ ngôn khi tài nguyên huấn luyện và suy
luận bị giới hạn. Bốn câu hỏi nghiên cứu được đặt ra:

- **RQ1 — Năng lực nền:** tiền huấn luyện từ đầu ở quy mô 60M–63M khác với việc dùng mô
  hình đã tiền huấn luyện 135M–3B như thế nào về độ trôi chảy và tuân thủ điều kiện?
...
- **RQ4 — Kiểm soát khi suy luận:** validation, chuẩn hóa định dạng và rewrite đóng góp
  ở mức nào so với năng lực của checkpoint gốc?

E1–E5 đại diện cho năm thiết kế thực nghiệm với các biến can thiệp khác nhau. Kết luận
nhân quả chỉ được rút ra từ các thí nghiệm loại trừ trong từng hướng, với biến can thiệp
được kiểm soát. Quy trình đánh giá chung ở Mục 4 đo hiệu năng toàn hệ thống; vì không
đồng thời kiểm soát kiến trúc, dữ liệu, quy mô và hậu xử lý, kết quả này không thể dùng
để quy chênh lệch cho một yếu tố riêng lẻ.

### 1.2 Tác vụ và dữ liệu

Nguồn dữ liệu chính là `klusai/ds-tf1-en-3m` (TF1-EN-3M), một bộ truyện ngụ ngôn tổng
hợp gồm đề bài có cấu trúc và phần nội dung tương ứng. Nghiên cứu sử dụng hai dạng đầu
vào có điều kiện:

- E2 sử dụng `Nhân vật` và `Bài học`, phù hợp với định dạng huấn luyện của V16;
- E1, E3, E4 và E5 sử dụng năm trường `Nhân vật`, `Bối cảnh`, `Thử thách`, `Kết quả` và `Bài học`.

Ứng dụng dùng chung gồm FastAPI, React và lớp phục vụ Ollama/MLX; hỗ trợ truyền kết quả
theo thời gian thực và chế độ so sánh. Mỗi hướng có một hệ thống đại diện, được đăng ký
như một backend riêng để kiểm tra khả năng vận hành trước khi đưa vào đánh giá.

### 1.3 Các chỉ số đánh giá

Bốn khía cạnh chính của đầu ra được theo dõi như sau:
...
| Bài học | Bài học đạo đức có rõ ràng, phù hợp với diễn biến và đầy đủ không? |
| Điều kiện | Các điều kiện đầu vào có thực sự chi phối câu chuyện không? |

Các thước đo tự động dưới đây được dùng để đánh giá chất lượng bề mặt:

| Thước đo | Cách tính và ý nghĩa | Hướng mong muốn | Lưu ý |
|---|---|---|---|
| Distinct-1 | Số unigram khác nhau chia cho tổng số unigram trong tập truyện; đo độ đa dạng từ vựng | cao hơn | Văn bản ngẫu nhiên hoặc kém mạch lạc cũng có thể đạt điểm cao |
...
| Self-BLEU | Mức chồng lặp n-gram trung bình giữa các truyện do cùng hệ thống sinh; đo độ giống nhau trong tập đầu ra | thấp hơn | Điểm thấp không đồng nghĩa truyện hay; nhiễu cũng có thể làm điểm thấp |
| Flesch Reading Ease | `206,835 − 1,015·(từ/câu) − 84,6·(âm tiết/từ)`; ước lượng độ dễ đọc của tiếng Anh | cao hơn; khoảng 80–100 thường được xem là dễ đọc với trẻ em | Không đo logic, nội dung hay độ đúng của bài học |

Trong triển khai E1, Distinct được tính trên các token được tách theo khoảng trắng;
Self-BLEU là độ chính xác 4-gram trung bình trên mọi cặp truyện; Flesch được tính cho
từng truyện rồi lấy trung bình. Vì các giá trị phụ thuộc cách tách token, cỡ mẫu và cách
tính BLEU, chúng chỉ nên được so sánh trong cùng một quy trình đánh giá. Tỷ lệ khớp các
trường và tỷ lệ có dòng bài học đo mức độ đúng định dạng đầu ra, không thay thế cho việc
đánh giá quan hệ nhân quả. Điểm do LLM chấm cũng chỉ nên được so sánh khi giữ cố định
giám khảo, thang điểm, đề bài, cấu hình lấy mẫu và cỡ mẫu.

### 1.4 Thiết kế đánh giá

Nghiên cứu sử dụng hai lớp đánh giá. **Đánh giá nội bộ** so sánh các biến thể trong cùng
một hướng tiếp cận theo quy trình của thành viên phụ trách; các điểm này không được dùng
để xếp hạng E1–E5 vì khác tập đề, giám khảo và thang đo.

**Đánh giá chung** chạy hệ thống đại diện của mỗi hướng trên cùng 25 đề để tạo đầu ra mới,
cố định seed và cấu hình giải mã, ẩn danh mô hình trước khi chấm bằng cùng một giám khảo
Gemma. Thiết kế này cho phép so sánh trực tiếp ở cấp hệ thống, nhưng không khiến năm
hướng trở thành một thí nghiệm đối chứng hoàn toàn tương đương; đồng thời, ảnh hưởng của
kích thước mô hình và chi phí suy luận vẫn chưa được cô lập hoàn toàn.

## 2. Dữ liệu và phương pháp

| Hướng tiếp cận | Mô hình nền | Biến can thiệp/chủ đề chính | Hệ thống đại diện |
|---|---|---|---|
| E1 · Lê Hải Triều (20252611M) | khởi tạo ngẫu nhiên; thiết kế kiểu Llama 30M/60M | ngân sách token, thay đổi dữ liệu, hậu huấn luyện, tăng quy mô | `slm-60m` |
| E2 · Đào Đức Tùng (20252612M) | khởi tạo ngẫu nhiên; thiết kế kiểu GPT 63M | tokenizer, tiền huấn luyện, điều kiện đầu vào có cấu trúc | `v16-conditioned` |
| E3 · Nguyễn Công Thanh (20252610M) | SmolLM2-135M | vị trí đặt LoRA theo tầng/mô-đun | `tsv3-smollm135-best` |
| E4 · Nguyễn Thị Phương Liên (20252130M) | Llama 3.2 3B Instruct | so sánh SFT/LoRA với tăng cường đề bài, hậu xử lý và repair | Base + Repair |
| E5 · Nguyễn Đình Lê Hoàng (20252737M) | Llama 3.2 3B Instruct | so sánh QLoRA qua 1 và 3 chu kỳ, GGUF Q4 | `llama3-fable-1000-q4` |

### 2.1 Tổng quan về bằng chứng thực nghiệm

Mức độ lưu trữ artifact giữa các hướng không giống nhau. Bảng dưới phân biệt số liệu từ
các lần chạy thực tế với thông tin chỉ có trong mô tả cấu hình:

| Cấu hình | Dữ liệu và cách chia | Cấu hình huấn luyện | Đầu ra do mô hình sinh |
|---|---|---|---|
| E1 · Lê Hải Triều (20252611M) | có nhật ký xây dựng corpus | có script và nhật ký | mẫu chạy cục bộ + 25 lần chạy trong vòng chung |
| E2 · Đào Đức Tùng (20252612M) | có manifest và corpus đã lưu | có manifest V16, mã PyTorch và wrapper Colab | 100 đầu ra cục bộ + 25 đầu ra trong vòng chung |
| E3 · Nguyễn Công Thanh (20252610M) | có mô tả seed/cách chia | có cấu hình + base/best đã gộp và xuất GGUF | trích đoạn chạy cục bộ + 25 đầu ra trong vòng chung |
| E4 · Nguyễn Thị Phương Liên (20252130M) | có manifest cho 300/10k | công thức Failure-LoRA có tài liệu; Drive có bốn GGUF | CSV cục bộ + 25 đầu ra trong vòng chung, gồm bản thô/bản repair |
| E5 · Nguyễn Đình Lê Hoàng (20252737M) | có JSONL huấn luyện/kiểm định | có notebook + checkpoint/adapter/GGUF | 25 đầu ra trong vòng chung |

Các artifact trên Drive được dùng để đối chiếu dữ liệu, cấu hình và đầu ra của từng hướng.
Báo cáo chỉ vẽ biểu đồ từ số đo thực tế đã lưu; không nội suy các đường cong còn thiếu.

**Hồ sơ kiến trúc của năm hệ thống đại diện.** Cả năm đều là mô hình ngôn ngữ nhân quả
kiểu decoder-only: tại mỗi vị trí, mô hình chỉ nhìn các token trước đó rồi dự đoán xác suất
của token tiếp theo. Các thiết kế theo phong cách Llama (E1, E3–E5) dùng chuỗi khối
`RMSNorm → attention nhân quả có RoPE → residual → RMSNorm → SwiGLU MLP → residual`.
Riêng E2 dùng chuỗi khối theo phong cách GPT-2:
`LayerNorm → multi-head attention → residual → LayerNorm → GELU MLP → residual`,
đồng thời dùng bảng vị trí học được. “GPT 63M” và “Llama 60M” là tên mô tả hai thiết
kế do nhóm tự xây dựng, không phải các mô hình GPT hay Llama được phát hành sẵn.

E1 và E2 là **hai lần huấn luyện từ đầu, hoàn toàn độc lập**: E1 tạo `slm-60m`, còn E2 tạo
`v16-conditioned`. Hai lần huấn luyện cùng giải một bài toán và cùng được đưa vào vòng đánh giá
chung, nhưng không phải hai cấu hình trong cùng một lần chạy, cũng không phải một phép
ablation chỉ thay backbone. Vì vậy, sơ đồ dưới đây đặt chúng thành hai luồng riêng;
chênh lệch E1–E2 là chênh lệch giữa hai hệ thống, không thể quy riêng cho kiến trúc.

![Sơ đồ hai lần huấn luyện độc lập E1 và E2, với hai thiết kế block khác nhau.](figures/llama-vs-gpt2-architecture.svg){width=100%}

**Mã huấn luyện PyTorch và cấu hình tham khảo.** E2 V16 được huấn luyện thật trên
Colab bằng PyTorch và Hugging Face Transformers. Trong `feat/td`,
`scripts/train_v16.py` dùng `GPT2Config` và `GPT2LMHeadModel` cho pha tiền huấn luyện,
sau đó dùng `AutoModelForCausalLM` và `Trainer` cho các pha điều kiện hóa và nhân quả;
`scripts/colab_v16_train.py` điều phối ba pha trên máy Colab. Sau khi huấn luyện,
checkpoint Hugging Face được chuyển thành artifact MLX để phục vụ local; MLX không phải
framework huấn luyện V16.

Đoạn mã dưới đây dùng `LlamaConfig` và `GPT2Config` để tóm tắt các kích thước cốt lõi
của hai thiết kế. E1 và E2 vẫn là hai lần huấn luyện độc lập, với tokenizer và runner
riêng. Vì vậy, `docs/model_architecture_configs.py` là bản cấu hình tham khảo dễ đọc,
còn implementation huấn luyện thật của E2 nằm ở các script V16 nêu trên.

```python
from transformers import GPT2Config, LlamaConfig

llama_cfg = LlamaConfig(
    vocab_size=12_000, hidden_size=768, intermediate_size=2_048,
    num_hidden_layers=8, num_attention_heads=12, num_key_value_heads=4,
    max_position_embeddings=1_024, rope_theta=10_000.0,
    rms_norm_eps=1e-5, tie_word_embeddings=True,
)

gpt2_cfg = GPT2Config(
    vocab_size=16_384, n_positions=1_024, n_ctx=1_024,
    n_embd=768, n_layer=7, n_head=12, n_inner=3_072,
...
Khi đọc cấu hình, cần xem các trường này cùng nhau: `num_key_value_heads=4` tạo GQA ở E1,
trong khi `n_head=12` ở E2 là multi-head attention đầy đủ; `rope_theta` mô tả RoPE,
còn `n_positions`/`n_ctx` mô tả bảng vị trí học được. Hai lần huấn luyện có cùng hidden size
(`hidden_size/n_embd=768`), nhưng khác số block, attention và MLP; đó là khác biệt giữa
hai thiết kế và hai lần huấn luyện, không phải một phép so sánh chỉ thay một biến.

| Hướng | Số tham số của hệ thống | Số khối × kích thước ẩn | Attention | FFN |
|---|---:|---:|---|---:|
...
Trong cả năm artifact đại diện, embedding đầu vào cũng được dùng làm ma trận chiếu đầu
ra. Vì vậy, sau lớp chuẩn hóa cuối, mỗi trạng thái ẩn được chiếu thành một vector logit có
kích thước đúng bằng vocabulary; các token có xác suất cao được lấy mẫu để nối tiếp chuỗi.

| Hướng | Tokenizer và vocabulary | Cửa sổ ngữ cảnh | Định dạng input → output | Trọng số và artifact dùng để chạy |
|---|---|---|---|---|
| E1 | BPE tương thích GPT-2, 12.000 token; có `<\|story\|>`, `<\|end\|>`, `<\|pad\|>` | huấn luyện: 1.024 token; runner chung: 2.048 | năm trường dạng chỉ dẫn + `<\|story\|>` → token truyện → `<\|end\|>` | học toàn bộ 59,56M từ đầu; đánh giá bằng GGUF Q8_0 |
| E2 | Metaspace BPE, 16.384 token; sáu thẻ `<char>…</char><moral>…</moral><story>…</story>` | 1.024 token; pha causal dùng block 512 | character + moral trong các thẻ → phần truyện; loss của prompt bị mask | học toàn bộ 62,99M từ đầu bằng PyTorch trên Colab; chuyển sang artifact MLX để phục vụ |
| E3 | GPT-2 BPE của SmolLM2, 49.152 token | mô hình hỗ trợ 8.192; thí nghiệm huấn luyện ở 512 | `system_message +` đề năm trường → phần truyện sinh ra | giữ nguyên base; học LoRA C 4,88M; vòng chung dùng base FP16 + adapter PEFT |
| E4 | Llama BPE, 128.256 token | mô hình hỗ trợ 131.072; runner dùng 2.048 | system + đề năm trường → assistant story → validator → rewrite khi cần → chuẩn hóa `Moral:` | checkpoint nền Q4_K_M, không huấn luyện thêm trong hệ thống đại diện |
| E5 | Llama BPE, 128.256 token | mô hình hỗ trợ 131.072; huấn luyện và runner dùng 2.048 | chat template `system/user/assistant` với năm trường → assistant story → `<\|eot_id\|>` | base 4-bit khi QLoRA; gộp adapter rồi xuất GGUF Q4_K_M |

Khi đọc kết quả chung, cần lưu ý hai khác biệt về định dạng đầu vào. E1 được huấn luyện
với `<|story|>` nhưng runner chung truyền trực tiếp đề năm trường; E3 được huấn luyện với
`system_message + prompt` nhưng runner chung chỉ truyền phần đề. E2, E4 và E5 được chạy
theo đúng định dạng đầu vào của artifact đại diện. Các khác biệt này không làm thay đổi
kiến trúc mô hình nhưng có thể ảnh hưởng điểm tuân thủ.

### 2.2 E1 — Llama 30M/60M huấn luyện từ đầu — Lê Hải Triều (20252611M)

Có bốn nhóm can thiệp được đánh giá trên cùng một dòng mô hình: ngân sách tiền huấn luyện,
phân bố dữ liệu, phương pháp hậu huấn luyện và quy mô tham số. Các phép so sánh nội bộ
dùng prompt giữ lại để kiểm tra, seed bắt cặp và cùng rubric; điểm nội bộ chỉ dùng để so
sánh các biến thể E1.

**Dữ liệu và mục tiêu tối ưu.** Mỗi mẫu TF1 được mã hóa thành
`<5 slot + gợi ý độ dài> <|story|> <truyện> <|end|>`. Token thuộc prompt bị mask bằng
`-100`; hàm mất mát cross-entropy chỉ được tính trên truyện và token kết thúc. Bộ lọc giữ
truyện 60–320 từ. Slot dropout tạo các tập con điều kiện trong quá trình huấn luyện. Tokenizer BPE
12.000 token được huấn luyện riêng để giảm chi phí embedding. Phase 1 dùng 400.000
truyện; Phase 2 giữ cùng quy mô nhưng thay phân bố dữ liệu. Lần chạy 60M lọc và loại trùng
toàn bộ nguồn dữ liệu còn 2.341.231 truyện, tương đương 934M token, không lặp lại epoch.

**Cấu hình mô hình.**

| Biến thể | Tham số | Khối | Kích thước ẩn / FFN | Query/KV head | Vocabulary | Ngữ cảnh |
|---|---:|---:|---:|---:|---:|---:|
| Llama 30M | 36,6M | 8 | 512 / 2.048 | 8 / 2 | 12.000 | 512 |
| `slm-60m` | 59.560.704 | 8 | 768 / 2.048 | 12 / 4 | 12.000 | 1.024 |

Cả hai biến thể dùng RoPE, GQA, RMSNorm, SwiGLU và embedding chia sẻ đầu vào/đầu ra.
AdamW có β=(0,9; 0,95), weight decay 0,1 và gradient clip 1,0. Lần chạy 30M dùng fp16
trên T4, batch hiệu dụng 128 chuỗi, khoảng 33k token/bước. Lịch Warmup–Stable–Decay
(WSD) có warmup 2%, giữ LR đỉnh `3e-3`, rồi decay trong 20% số bước cuối mỗi pha. Lần
chạy 60M dùng cùng công thức tối ưu hóa và lưu checkpoint mỗi 500 bước.

**Quá trình tiền huấn luyện.** Mốc v1 cố ý dùng ngân sách thấp để kiểm tra giả thuyết mô
hình chưa được huấn luyện đủ. Phase 1 tăng số token nhưng giữ nguyên kiến trúc; Phase 2
tiếp tục từ cùng checkpoint và thay phân bố corpus; lần chạy 60M đồng thời thay đổi quy
mô mô hình, độ dài ngữ cảnh và số token.

| Giai đoạn | Dữ liệu / bước | Loss cuối | PPL trên tập giữ lại | Điểm giám khảo nội bộ | Can thiệp |
|---|---:|---:|---:|---:|---|
...
| 60M | 2,34M / 10.000 | 1,058 | 2,87 | 8,96 | toàn bộ TF1, ngữ cảnh 1.024 |
...
Loss giảm đều và không xuất hiện spike đáng kể. Mỗi giai đoạn decay tạo thêm một mức giảm
ở cuối pha, phù hợp với lịch WSD. Các giá trị 1,447 và 1,278 là loss của cửa sổ log cuối, không
phải trường `train_loss` tổng hợp của Hugging Face.

**Chẩn đoán theo scaling law.** Mốc v1 chỉ dùng khoảng 1,7 token/tham số và đạt 2,50/10.
Khi giữ nguyên mô hình nhưng tăng ngân sách lên khoảng 600M token, điểm judge tăng lên
6,00 và loss giảm mạnh. Phép fit log-log trên loss sau warmup cho R²=0,96; đường cong
chưa có dấu hiệu bão hòa trong phạm vi quan sát. Kết quả này ủng hộ giả thuyết mô hình
chưa được huấn luyện đủ ở cấu hình v1 và tạo cơ sở thực nghiệm để tăng ngân sách trước
khi thay kiến trúc.

![Kiểm tra chế độ power-law của loss theo số bước.](trieulh/report/figures/04_scaling_law.png){width=72%}

Một thay đổi ở bước giải mã cũng được kiểm tra riêng. Repetition penalty 1,3 phạt cả việc lặp tên
nhân vật, làm danh tính nhân vật thay đổi giữa truyện; giảm xuống 1,1 tăng điểm nội bộ
6,00 → 6,20 mà không cập nhật trọng số. Kết quả này được xem là hiệu ứng của decoding,
không gộp vào hiệu ứng tiền huấn luyện.

**Can thiệp phân bố dữ liệu.** Phân tích đầu ra Phase 1 cho thấy cụm `wise old owl`
xuất hiện trong khoảng 90% truyện sinh, trong khi tỷ lệ trong dữ liệu gốc chỉ là 28%.
...
Điều này cho thấy hiện tượng mode collapse cục bộ có thể được xử lý ở phân bố huấn luyện thay
...
PPL trên tập giữ lại giảm từ 4,18 xuống 3,56. Mốc 3,56 gần với `exp(1,278)=3,59`, cho thấy
khoảng cách giữa loss cuối và PPL trên tập giữ lại nhỏ trong cách đo của E1. Các chỉ số
...
Điểm judge nội bộ tăng theo ba loại can thiệp khác nhau: ngân sách token tạo mức tăng
...
**Phân tích hậu huấn luyện và suy luận.** Sau Phase 2, các phương pháp được đánh giá bằng
cùng prompt giữ lại để kiểm tra và cùng baseline trong một phiên:

| Phương pháp | Cơ chế | Tín hiệu học trong E1 | Có cập nhật trọng số? |
|---|---|---|---|
| DPO — Direct Preference Optimization | tăng xác suất tương đối của truyện được chọn so với truyện bị loại, đồng thời neo vào mô hình tham chiếu | 194 cặp `chosen/rejected` có chênh điểm judge ≥1 | có |
| SFT-on-best — tinh chỉnh có giám sát trên mẫu tốt nhất | chọn truyện tốt nhất trong mỗi nhóm ứng viên rồi tối ưu cross-entropy với truyện đó làm đích | 42 truyện thắng tương đối trong nhóm | có |
...
| GRPO-lite — tối ưu chính sách tương đối theo nhóm | sinh rollout mới, chuẩn hóa reward trong nhóm cùng prompt, cập nhật REINFORCE và phạt KL so với mô hình gốc | 60 bước × 16 rollout; reward từ judge | có |
| Distillation — chưng cất đầu ra | dùng truyện của mô hình teacher làm đích SFT; E1 không dùng soft logits | 600 truyện do Qwen3-4B sinh | có |
| Best-of-N — chọn mẫu ở bước suy luận | sinh N ứng viên và trả về ứng viên có điểm judge cao nhất | N=3; temperature 0,5/0,8/1,1 | không |
...
DPO học phân biệt chosen/rejected trên tập huấn luyện nhưng không làm thay đổi phân bố
trên tập giữ lại. RAFT và SFT chỉ tăng trọng số cho những mẫu vốn đã nằm trong phân bố
dữ liệu, không có gradient âm để loại bỏ các mode yếu. GRPO có bước khám phá và gradient
âm, nhưng KL cuối chỉ khoảng `1e-3` nat/token nên chính sách gần như không đổi trong ngân
sách 60 bước. Distillation là can thiệp duy nhất tạo ra độ lệch rõ, nhưng mô hình nhỏ học
theo văn phong của teacher và làm giảm chất lượng. Ngược lại, Best-of-N không thay đổi
phân bố; nó khai thác những mẫu tốt đã tồn tại và làm giảm phương sai lựa chọn.

**Độ tin cậy của giám khảo nội bộ.** Cùng một checkpoint được chấm lại cho chênh lệch
khoảng ±0,4 điểm ở n=15. Vì vậy, E1 quy ước rằng chênh lệch dưới 0,5 tại n=15 chưa đủ
để kết luận và xác nhận các kết quả chính ở n=45 với seed bắt cặp. Quy tắc này khiến hai
kết quả sơ bộ không còn được giữ: DPO tăng adherence và GRPO tăng 0,45 điểm.

![Độ biến thiên khi chấm lặp cùng checkpoint và ảnh hưởng của cỡ mẫu.](trieulh/report/figures/18_judge_noise.png){width=76%}

**Kiểm tra trên ứng dụng.** Phase 1, Phase 2 và Phase 2+DPO được chạy ở hai chế độ:
sinh tự do và sinh với đủ năm trường. Mỗi ô gồm bốn prompt, seed bắt cặp; đầu ra được
chấm bởi giám khảo Qwen3-4B của ứng dụng và đọc độc lập thêm một lượt bằng Claude. Hai
giám khảo cho cùng thứ tự tương đối. DPO thường tạo chuỗi giống Phase 2 trên phần lớn độ dài
và chỉ rẽ nhánh ở đoạn cuối, phù hợp với kết luận rằng cập nhật này không dịch phân bố
đáng kể.

| Biến thể | Sinh tự do: giám khảo / Claude | Đủ năm trường: giám khảo / Claude | Độ tuân thủ đủ năm trường |
|---|---:|---:|---:|
...
tham số, ngữ cảnh 1.024 và được huấn luyện 10.000 bước trên 934M token. Loss cuối là
1,058, PPL trên tập giữ lại là 2,87. Trên 45 prompt seed bắt cặp của quy trình E1, mô hình
60M tăng 1,017 điểm so với 30M Phase 2, với t=6,53; cao hơn ở 36 đề, bằng ở 5 đề và
thấp hơn ở 4 đề.
...
chênh lệch vượt mức nhiễu đo được của giám khảo; distillation từ teacher còn làm giảm chất
lượng. Trái lại, gói tăng quy mô lên 60M, ngữ cảnh 1.024 và 934M token tiền huấn luyện
tăng điểm bắt cặp 1,017 trên 45 đề và cao hơn ở 36/45 đề. Bằng chứng này ủng hộ việc
...
đã thử không đưa được lợi ích này vào mô hình: dữ liệu preference tự sinh có biên chất lượng
hẹp, tập mẫu tốt quá nhỏ so với phân bố tiền huấn luyện ban đầu, còn dữ liệu từ teacher lệch phân bố
...
So sánh 30M với 60M cũng không phải một thí nghiệm loại trừ riêng cho số tham số, vì số
tham số, cửa sổ ngữ cảnh và ngân sách token thay đổi đồng thời. Do đó không thể suy ra
một ngưỡng năng lực phổ quát từ phép đo này. Kết luận hợp lệ là toàn bộ gói tăng quy mô cải thiện rõ
phân bố sinh mặc định, trong khi các can thiệp hậu huấn luyện chi phí thấp đã thử
không tạo mức cải thiện tương đương. Việc tự đo nhiễu của giám khảo khoảng ±0,4 điểm còn cho
thấy các chênh lệch nhỏ phải được chấm lặp hoặc đánh giá trên mẫu lớn hơn trước khi
xem là hiệu ứng thực sự.

Điểm 3,30 trong vòng chung không phủ định các thí nghiệm loại trừ nội bộ, nhưng bộc lộ một
hạn chế khi triển khai: checkpoint được huấn luyện với token `<|story|>` trong khi runner chung
không truyền token đó. E1 vì vậy chứng minh được hiệu quả của gói tăng quy mô trong đúng
định dạng huấn luyện, nhưng chưa chứng minh khả năng giữ chất lượng khi giao diện prompt
...
E2 tập trung vào ba vấn đề: chất lượng biểu diễn token, khả năng dùng hai trường
`character + moral` làm điều kiện đầu vào, và khả năng biến điều kiện đó thành chuỗi
tính cách→lựa chọn→hệ quả. Toàn bộ checkpoint được huấn luyện từ khởi tạo ngẫu nhiên
hoặc tiếp tục từ checkpoint do chính E2 tạo ra; không sử dụng mô hình ngôn ngữ đã tiền
huấn luyện làm trọng số khởi đầu. Các điểm trong tiểu mục này thuộc quy trình đánh giá
nội bộ E2 và chỉ dùng để so sánh các biến thể E2.

**Thiết kế thực nghiệm.** Các biến thể được tổ chức thành những thí nghiệm nối tiếp theo
từng giả thuyết; mỗi kết luận chỉ dựa trên so sánh có đối chứng trong cùng hàng:

| Nhóm biến thể | Nội dung thay đổi | Đối chứng | Kết quả đo được |
|---|---|---|---|
| V1–V3 | tokenizer, quy mô 29,9M→63M và prompt masking | V1/V2; V2/V3 | sửa lỗi ranh giới từ; bám đúng trường đầu vào hơn và kết thúc sạch |
...
| V7–V8 | sinh `plan + story` so với chưng cất trực tiếp story | cùng teacher corpus | bỏ dàn ý làm giảm độ lệch khi chạy thật nhưng chưa tạo được causal-pass |
| V9–V10 | trộn replay với 6.278 rồi 13.270 truyện nhân quả | V8 và V3 | giữ được độ trôi chảy; causal pass không tăng |
| V11 | thêm thẻ ngữ nghĩa `<moral_class>` | cùng trọng số, có/bỏ thẻ | thẻ lớp kích hoạt kiểu truyện ngắn, không tạo được khả năng lập kế hoạch |
| V12 | tăng riêng số layer: 63M→98M | cùng tokenizer, dữ liệu, seed và lịch train | causal pass +1 điểm %, CI chạm 0 |
| V13 | DPO trên cặp teacher/failure đã khớp độ dài | V12-98M | độ chính xác chọn truyện tốt hơn đạt 54,4%; causal-pass không đổi |
| V14 | tám epoch chỉ dùng dữ liệu nhân quả | V3 | fluency giảm; causal pass 0–5% |
| V15 | loss phụ liên kết story–moral | V3 | matching đạt 75,4%; không chuyển thành khả năng sinh tự do |
| V16 | tăng tiền huấn luyện 200k→500k rồi điều kiện hóa/nhân quả | V3 và ba epoch causal | fluency tăng trước khi học nhân quả; liên kết nhân quả không tăng |

**Chuẩn bị dữ liệu.** TF1-EN-3M được đọc tuần tự; các bản ghi tiếng Anh có
`character`, `moral` hợp lệ và thân truyện dài tối thiểu 80 ký tự mới được giữ lại. Corpus V16 gồm
500.000 bản ghi hợp lệ đầu tiên theo thứ tự nguồn. Pha điều kiện hóa lọc tiếp những
truyện có cụm nhân vật xuất hiện nguyên văn, thu được 108.487 mẫu: 103.063 mẫu train và
...
sinh truyện theo chuỗi conflict→choice→consequence; một mô hình chấm điểm 26B chỉ giữ lại các mẫu đạt
yêu cầu về nhân vật, liên kết sự kiện, bài học và kết thúc. Trong 11.458 mẫu mới được
chấm, 7.665 mẫu đạt strict-pass. Sau khi gộp 6.278 mẫu strict từ V8 và loại trùng, tập
train nhân quả có 13.270 mẫu, phủ 100 bài học. Hai tập đánh giá cố định gồm các moral
chưa xuất hiện và các cặp `character–moral` được giữ lại để kiểm tra; vòng sàng lọc dùng
20 đề, còn đánh giá đầy đủ dùng 100 đề khi cấu hình đạt điều kiện.

**Tokenizer.** V1 dùng BPE 8.192 token mà không có bước tiền tách token. Khoảng trắng được
học như ký tự thông thường, dẫn đến các từ bị tách vụn như `par ty` và `w o ven`. Từ V2, tokenizer
được cố định ở Metaspace BPE 16.384 token: khoảng trắng được mã hóa bằng sentinel
trước BPE và phục hồi khi decode. Phép kiểm tra round-trip trên văn bản giữ lại không làm thay
đổi chuỗi.

V1 và V2 đồng thời khác quy mô mô hình, vocabulary và số bước huấn luyện; vì vậy biểu đồ
dưới đo hiệu quả của **toàn bộ gói thay đổi cấu hình**, không cô lập riêng tokenizer. Distinct-1 và
...
![E2: so sánh chỉ số không cần tham chiếu giữa V1 dùng BPE thô và V2 dùng Metaspace BPE. Hai cấu hình còn khác quy mô mô hình và vocabulary, nên đây không phải thí nghiệm loại trừ chỉ thay tokenizer.](figures/tracks/e2_tokenizer_metrics.png){width=96%}

**Kiến trúc và ba pha huấn luyện.** “GPT 63M” là một `GPT2LMHeadModel` được khởi tạo từ đầu với đúng
...
LayerNorm cuối. Mỗi khối gồm causal self-attention 12 head (64 chiều/head) và MLP
GELU-new `768 → 3.072 → 768`; output head dùng chung trọng số với token embedding.
Đầu vào có điều kiện có dạng
`<char>…</char><moral>…</moral><story>`; mô hình sinh token truyện cho tới
`</story>`, và loss chỉ tính trên phần truyện. Ba pha V16 được chạy bằng PyTorch và
Hugging Face Transformers trên Colab, dùng một GPU A100 trong thời lượng 100 phút:
...
![E2: đường loss và lịch tốc độ học trong hai pha tiền huấn luyện và điều kiện hóa. Nét đứt biểu thị đoạn không có log theo bước; điểm cuối là số đo thực tế, không phải kết quả nội suy.](figures/tracks/e2_training_curves.png){width=96%}

Biểu đồ cho thấy loss của pha tiền huấn luyện giảm nhanh ở giai đoạn đầu rồi dần ổn
định. Sang pha điều kiện hóa, loss huấn luyện và loss đánh giá tiếp tục giảm, còn tốc độ học
...
**Hiệu quả của gói thay đổi V1→V2.** Sửa tokenizer, tăng vocabulary và tăng mô hình từ
...
nhưng chuyển 103.063 mẫu sang mục tiêu chỉ tính loss trên phần truyện. Trên 100 đề,
khớp chính xác character tăng từ 18% lên 65%, khớp chính xác moral từ 17% lên 86%, khớp cả hai từ 3% lên
55%, và tỷ lệ sinh `</story>` tăng từ 0% lên 100%. Điểm chấm nội bộ ban đầu tăng
thể từ 5,06 lên 6,78. Các chỉ số này cho thấy prompt masking giúp mô hình sao chép đúng
hai trường và dừng sạch hơn; chúng chưa cho biết diễn biến có chứng minh bài học hay
không.

Sau đó, 100 thân truyện được chấm lại bằng bộ tiêu chí gồm bảy liên kết. V3 đạt fluency
...
Kết quả này dẫn đến ba tầng đánh giá độc lập cho E2:

1. **Bám đúng đầu vào:** nhân vật và bài học có xuất hiện, truyện có kết thúc sạch;
2. **Liên kết nhân quả:** tính cách chi phối lựa chọn, lựa chọn xử lý xung đột và hệ quả
   phát sinh từ lựa chọn;
3. **Bài học được suy ra:** bài học phải xuất phát từ chuỗi sự kiện, không chỉ được chép ở
   cuối truyện.

**Dữ liệu teacher và replay — V7 đến V10.** V7 yêu cầu mô hình sinh cả dàn ý rồi mới
viết truyện. Khi chạy thật, truyện lại phụ thuộc vào dàn ý do chính mô hình nhỏ tạo, nên lỗi
ở dàn ý truyền trực tiếp sang phần truyện. V8 bỏ dàn ý khỏi đầu ra và chưng cất trực
tiếp thân truyện do teacher sinh. Các truyện đích của teacher đạt fluency 7,75 và
moral-delivery 8,28, nhưng checkpoint V8 tốt nhất chỉ đạt 4,65 và khoảng 1,70 khi sinh
tự do; loss thấp khi ép mô hình bám theo truyện đích không chuyển thành quá trình sinh ổn định.

V9 và V10 kiểm tra liệu replay từ V3 có giữ chất lượng bề mặt khi học thêm dữ liệu
nhân quả hay không:
...
| V10 | 13.270 causal (25%) + 39.810 replay (75%) | V10/V3 primary 3,60/3,67; causal-pass cùng 2% | tăng gấp đôi dữ liệu nhân quả không làm causal-pass thay đổi |

V10 huấn luyện 830 bước, LR `3e-6`, cosine decay và batch hiệu dụng 64. Loss đánh giá nhân quả
giảm 3,404→2,968; replay loss giữ gần 1,530. Checkpoint bước 300 được
chọn qua vòng sàng lọc, sau đó so sánh mù với V3 trên 100 đề: V3 thắng 40, V10 thắng
36 và hòa 24.
...
replay loss giữ 1,547; checkpoint bước 600 có điểm sàng lọc cao nhất trong V11 nhưng vẫn
thấp hơn V3.

Thí nghiệm loại trừ dùng **cùng trọng số bước 600**, chỉ thay việc có hay không truyền thẻ
...
![E2: loss validation của V11 và thí nghiệm loại trừ cùng checkpoint bước 600 khi có hoặc bỏ thẻ lớp bài học.](figures/tracks/e2_v11_class_token.png){width=98%}

**V12 — thí nghiệm loại trừ về quy mô.** Hai mô hình 62.985.984 và 98.425.344 tham số được huấn luyện
...
phần trăm [0; 3]. Cận dưới của CI của causal-pass bằng 0, nên dữ liệu không hỗ trợ giả
...
độ dài. Sau 39 bước tối ưu, độ chính xác phân biệt chosen/rejected trên validation đạt
...
**V14 — tăng mức tiếp xúc với dữ liệu nhân quả.** V14 loại hoàn toàn replay và học tám epoch trên
13.270 truyện nhân quả, giữ checkpoint tại epoch 1, 2, 3, 5 và 8. Mốc V3 có
...
**V15 — loss phụ liên kết story–moral.** V15 thêm đầu phân loại nhị phân trên trạng
thái cuối để phân biệt moral đúng với moral hoán đổi; trọng số loss phụ là 0,5 và
prompt phụ không xuất hiện khi sinh. Độ chính xác trên tập giữ lại tăng 73,18%→75,44%, cao
hơn mức ngẫu nhiên và vượt mốc 70% dùng để kiểm tra khả năng biểu diễn. Tuy nhiên, fluency giảm từ 6,20 của V3
...
**V16 — tăng ngân sách tiền huấn luyện.** V16 quay lại 63M với khởi tạo ngẫu nhiên,
tăng corpus tiền huấn luyện từ 200.000 lên 500.000 truyện trước khi chạy lại pha
điều kiện hóa và ba epoch chỉ dùng dữ liệu nhân quả. Vòng sàng lọc cố định dùng 20 đề, temperature 0,2,
...
Ba checkpoint causal đạt fluency 5,15; 4,55; 5,20 và causal-pass tối đa 5%. Để chạy đủ
100 đề, cấu hình phải có causal-pass ≥10% và fluency không giảm quá một điểm; không cấu
hình nào đạt yêu cầu này nên không chạy đánh giá đầy đủ. `v16-conditioned` được chọn làm
mô hình dùng để chạy vì có chất lượng truyện tốt nhất trong V16, không phải vì đạt mục
tiêu liên kết nhân quả.

![E2: kết quả vòng sàng lọc trên 20 đề cho V3, V16-conditioned và ba checkpoint causal.](figures/tracks/e2_screen_metrics.png){width=96%}

**Kết luận E2.** Những cải thiện rõ nhất của E2 nằm ở biểu diễn token, chất lượng ngôn
ngữ và khả năng bám đúng trường đầu vào. Gói sửa V1→V2 loại bỏ lỗi vỡ từ, tăng Distinct-1/2 và giảm
...
học được ranh giới từ, hình thức prompt và phân bố văn phong khi mục tiêu huấn luyện cung cấp tín
...
token khi sinh. Ba năng lực này cần được tách riêng: nhận biết quan hệ
story-moral, tái tạo target khi học có teacher forcing, và tự xây dựng chuỗi
...
Các kết quả tiếp theo giúp thu hẹp thêm các giả thuyết nguyên nhân. Replay giữ được văn phong nhưng
không tăng causal-pass; thẻ `<moral_class>` chọn kiểu truyện ngắn của teacher thay vì
cung cấp một dàn ý hữu ích; huấn luyện chỉ bằng dữ liệu nhân quả tới tám epoch làm giảm fluency mà
...
mục tiêu phụ không gắn với quá trình giải mã. Một hướng khả dĩ là giám sát trực tiếp
các trạng thái kế hoạch hoặc dùng tín hiệu cấp chuỗi có thể tác động lên rollout, nhưng
...
corpus, một họ mục tiêu huấn luyện và một dải quy mô hẹp 63M–98M; một kiến trúc khác, dữ liệu có
liên kết nhân quả rõ hơn hoặc ngân sách lớn hơn có thể cho kết quả khác. Đóng góp chính
của E2 là chỉ ra rằng loss thấp, khả năng bám đúng đầu vào cao và story-moral matching tốt vẫn
...
Trong vòng chung, E2 được chạy đúng định dạng hai trường `character + moral`, còn đề
đánh giá chung chứa năm trường. Runner không truyền setting, challenge và outcome vào mô hình,
nên điểm 3,18/10 phản ánh một hệ thống hai điều kiện khi bị đánh giá trên yêu cầu năm
điều kiện. Điểm này phù hợp để đo mức tương thích của mô hình với giao diện chung,
...
nghĩa checkpoint đã đạt liên kết nhân quả.

### 2.4 E3 — So sánh vị trí LoRA trên SmolLM2-135M — Nguyễn Công Thanh (20252610M)

Ba cấu hình LoRA được so sánh trên cùng nền SmolLM2-135M, cùng dữ liệu và cùng ngân sách
huấn luyện. Biến được thay đổi là vị trí tầng và mô-đun được gắn adapter.

**Dữ liệu và mục tiêu.** Tập con 50.000 mẫu TF1 được lấy bằng cách xáo trộn theo luồng với
bộ đệm 10.000, seed 42. Cách lấy mẫu được cố định và giống nhau giữa các nhánh, nhưng gần với
việc “xáo nhẹ phần đầu” hơn là lấy mẫu đều trên toàn corpus. `system_message + prompt` là
phần điều kiện, `fable` là phần truyện; mọi token điều kiện bị mask `-100`, loss chỉ tính trên token
truyện và token kết thúc. Mỗi nhánh học 2 epoch với ngữ cảnh 512 token. Tập giữ lại cố định gồm
500 hàng.

**Kiến trúc và LoRA.** SmolLM2-135M là mô hình decoder kiểu Llama với chính xác 134.515.008
tham số: embedding/output head dùng chung vocabulary 49.152 token, 30 khối hidden 576,
GQA 9 query head/3 KV head và MLP SwiGLU `576 → 1.536 → 576`. Mô hình hỗ trợ ngữ cảnh
8.192 token, còn thí nghiệm cố định chuỗi ở 512 token. Mô hình nền được đóng băng; LoRA chỉ
...
AdamW dùng LR đỉnh `2e-4`, cosine decay, warmup 3%, bf16 trên một GPU Colab L4, batch
16 × gradient accumulation 2 = 32, khoảng 3.125 bước/nhánh (≈1.563 bước/epoch × 2
epoch). Loss huấn luyện thực tế của cả ba nhánh được lấy lại từ log W&B (312
điểm/nhánh); learning rate tuân theo lịch cosine trong cấu hình — được xác định bởi công thức
warmup 3% + cosine decay về 0, đỉnh 2e-4. Hệ thống tổng hợp không giữ log LR theo
bước, nên phần LR trong hình là lịch theo cấu hình (đúng với scheduler đã chạy),
không phải đường đo thực tế.
...
**Perplexity và khả năng so sánh.** Perplexity trên tập giữ lại được tính bằng
`exp(mean cross-entropy)` trên 500 mẫu cố định, theo teacher forcing; loss chỉ cộng trên token fable (token điều kiện bị
mask `-100` nên không vào mẫu số). Vì cả ba nhánh dùng chung tokenizer GPT-2 BPE của
SmolLM2 (49.152 token) và chung cách mask, perplexity có thể so sánh trực tiếp và công bằng
*trong phạm vi E3*. Tuy nhiên, perplexity tính trên token nên không thể so trực tiếp với
...
**Kết quả trên tập giữ lại và điểm chấm.**
...
![E3: thí nghiệm loại trừ vị trí LoRA theo perplexity trên tập giữ lại (trái, thấp hơn tốt hơn) và điểm giám khảo nội bộ Qwen2.5-7B (phải, cao hơn tốt hơn); nhánh C dẫn đầu cả hai thước đo. Màu mỗi nhánh khớp với hình động lực huấn luyện phía trên.](figures/tracks/e3_lora_ablation.png){width=96%}

PPL và điểm chấm nội bộ Qwen2.5-7B (n=50/nhánh) cùng cho thứ tự C > A > B > nền. So
sánh A/B cho thấy phủ toàn bộ tầng tốt hơn chỉ đặt ở tầng cuối. So sánh A/C cho thấy mở
rộng sang MLP quan trọng hơn chỉ tăng mô-đun chú ý. Tập sinh chẩn đoán có 100 truyện cho mỗi
nhánh với temperature 0,8, top-p 0,9, repetition penalty 1,3; điểm chấm dùng 50 truyện đầu,
greedy và chấm bốn trục. Adapter C được merge, xuất GGUF Q8_0 khoảng 138MB và đăng ký
Ollama.

**Kết luận E3.** Trong cùng ngân sách huấn luyện, vị trí đặt LoRA ảnh hưởng rõ
đến chất lượng thích nghi của SmolLM2-135M. Nhánh B chỉ gắn q/v ở một phần ba số tầng cuối
...
Perplexity và điểm chấm không hoàn toàn tương đương. Nhánh B nhận được phần lớn mức giảm
PPL so với mô hình nền nhưng mức bám đề 4,78 lại thấp hơn mức 5,08 của mô hình nền.
...
đồng thời mỗi nhánh chỉ có một seed và giám khảo chưa được chấm lại. Vì vậy chưa thể tách
...
Bảy cấu hình trên Llama 3.2 3B được so sánh: mô hình nền, SFT-clean-3k, Failure-LoRA
...
3.072, GQA 24 query
head/8 KV head, MLP SwiGLU 8.192 và Llama BPE 128.256 token. Mô hình gốc hỗ trợ ngữ cảnh
131.072 token nhưng bộ chạy chỉ dùng 2.048 token. Đầu vào gồm system prompt về truyện trẻ em và
user prompt chứa năm trường; đầu ra đầu tiên là assistant message tối đa 400 token.
Validator kiểm tra hình thức và độ dài; nếu phát hiện lỗi nghiêm trọng, cùng mô hình nhận
thêm bản nháp và sinh lại tối đa 500 token. Cuối cùng hệ thống chuẩn hóa đúng một dòng
`Moral:`. Vì vậy đầu ra báo cáo là sản phẩm của một quy trình bao quanh mô hình nền, không
phải đầu ra của một checkpoint fine-tune mới.

**Tập dữ liệu thích nghi.**

- Failure-LoRA (tên artifact gốc) có 300 mẫu: 24 sai lệch quan sát trên benchmark và
  276 mẫu TF1 có đầu ra đích đúng, gắn cùng hệ phân loại. Chia 270/30. Các nhãn sai lệch có thể chồng nhau: 177 thiếu/rỗng
  bài học, 117 kết thúc không sạch, 187 bài học lệch, 59 thiếu outcome. Công thức huấn luyện
...
Kho mã nguồn không chứa notebook/checkpoint `trainer_state` của SFT-clean-3k, Failure-LoRA hay
Fluency-SFT-v1. Vì vậy cấu hình trên là thông tin được bàn giao cho Failure-LoRA; báo cáo
**không thể xác nhận** thời gian huấn luyện, đường loss/LR thực chạy hoặc gán nó cho hai lần
SFT còn lại. Đây là thiếu sót cần bổ sung từ artifact Kaggle nếu muốn tái lập train.

**Quy trình Base + Repair.** Mô hình nền sinh một lần với seed 5410. Bộ kiểm tra phân biệt
lỗi có thể sửa bằng luật với lỗi nghiêm trọng. Hậu xử lý chuẩn hóa dòng `Moral:`; chỉ khi
phát hiện lỗi nghiêm trọng mới gọi cùng mô hình để sinh lại. Tệp kết quả lưu cả
...
lượt đánh giá chung đã tính cả độ trễ và lỗi của lượt sửa.

Bộ kiểm tra nội bộ gồm 25 đề bài. Kết quả tự động cho thấy `Strict + Postprocess` đạt
...
SFT-clean-3k làm yếu độ trôi chảy và phần kết. LoRA 300 không sửa được dòng bài học.
LoRA 10k lọc kỹ vẫn có tỷ lệ `Moral:` rỗng 0,76, clean-ending 0,12 và đạt các chỉ số
thấp hơn `Base + Repair`. Base + Repair tạo đầu ra cho 25/25 đề, dòng Moral cuối truyện 1,00, exact moral 0,76,
...
Hai hình cho thấy một khác biệt về phương pháp: `Strict + Postprocess` có thể đạt
100% ở các kiểm tra định dạng xác định, nhưng `Base + Repair` được người chấm xếp cao
hơn về chất lượng tổng thể. Đóng góp của E4 nằm ở việc kiểm soát toàn hệ thống; không thể suy
...
soát tại thời điểm suy luận tăng độ tin cậy mà vẫn giữ năng lực kể chuyện của mô hình
nền.

Ba thử nghiệm fine-tuning cho thấy những kết quả không thuận lợi. SFT-clean-3k làm giảm
độ trôi chảy, cấu trúc và chất lượng kết thúc; Failure-LoRA 300 không sửa được lỗi
footer mục tiêu; Fluency-SFT trên 10.000 mẫu đã lọc vẫn có `Moral:` rỗng ở 76% đầu ra
...
ba công thức dữ liệu và mục tiêu huấn luyện cụ thể của E4 không vượt được quy trình dùng mô hình
nền.

So sánh đánh giá tự động và đánh giá thủ công cũng xác định phạm vi của từng chỉ số. Strict +
...
phải là toàn bộ quy trình, không phải checkpoint nền. Kết luận còn bị giới hạn bởi 25
đề tự động, 10 đề chấm tay và việc thiếu trainer state của các nhánh fine-tune; ngoài
ra Base + Repair dùng thêm một lượt gọi mô hình ở 5/25 đề nên không giữ cố định chi phí
suy luận với các hệ thống sinh một lượt.

### 2.6 E5 — QLoRA và lượng tử hóa Llama 3.2 3B — Nguyễn Đình Lê Hoàng (20252737M)

Áp dụng Unsloth QLoRA hạng 16 lên toàn bộ phép chiếu attention và MLP của
Llama 3.2 3B, rồi so sánh một với ba epoch; artifact cuối được lượng tử hóa
GGUF Q4_K_M.
...
900/100; câu “lấy mẫu ngẫu nhiên 1.000” trong báo cáo thành viên không khớp với code.
...
warmup 5 bước; LR đỉnh `2e-4`; fp16 hoặc bf16 tùy T4 hỗ trợ. Có 24.313.856 tham số được
huấn luyện, tương đương 0,75% mô hình. Hai lần chạy cho phép xem xét ảnh hưởng của số epoch
và kiểm tra đường xuất
...
**Diễn biến tối ưu qua ba epoch.** `trainer_state.json` ghi nhận cửa sổ loss giảm nhanh rồi phẳng:
...
LR sau warmup giảm gần tuyến tính về 0. Log checkpoint không có bản ghi đánh giá ở bước
...
Cần giữ tách bạch hai nguồn và không trộn lẫn các định nghĩa. Cả hai mô hình đã được lượng tử hóa khoảng
2GB; Modelfile dùng temperature 0,8, top-p 0,9, repetition penalty 1,1 và ngữ cảnh 2.048.
...
validation 0,488 và 0,453 cùng xu hướng với loss huấn luyện và chưa cho thấy dấu hiệu phân kỳ đến cuối
...
**Kết luận E5.** Lần chạy ba epoch xác nhận tính khả thi của việc thích nghi và chạy cục bộ
Llama 3.2 3B trong ngân sách phần cứng phổ thông. QLoRA chỉ cập nhật 24,31M tham số,
tương đương 0,75% mô hình, hoàn tất 339 bước trong khoảng 47,3 phút trên Tesla T4; sau
merge, artifact GGUF Q4_K_M khoảng 2GB chạy được bằng Ollama. Loss huấn luyện giảm mạnh ở
đầu run rồi ổn định quanh 0,4; validation loss giảm từ 0,488 ở epoch 1 xuống 0,453 ở
epoch 2 và chưa cho thấy phân kỳ tại mốc được lưu. Đây là bằng chứng về quá trình tối ưu ổn định
và khả năng đóng gói, không tự nó là bằng chứng về chất lượng truyện.

Thiết kế một so với ba epoch chưa tạo thành một thí nghiệm loại trừ đầy đủ. Artifact không giữ
...
đơn thuần rằng mô hình sử dụng tổ hợp điều kiện trong tập kiểm thử.
...
sinh trực tiếp. Kết quả chưa xác định phần cải thiện đến từ QLoRA, số epoch hay mô hình
...
### 2.7 Phân tích định tính các đầu ra

Các mẫu dưới đây được giữ nguyên tiếng Anh vì tác vụ đích là sinh truyện tiếng Anh.
Bốn mẫu đầu đến từ **đề bài và cấu hình cục bộ khác nhau**, nên chỉ dùng để minh họa hành vi;
mẫu E5 lấy từ lượt đánh giá chung để bổ sung đầu ra còn thiếu. So sánh trực tiếp chỉ dùng
toàn bộ 125 truyện ở §4. Dấu `[…]` là phần rút gọn khi trình bày, không phải token do mô hình
sinh.
...
Đầu ra giữ đúng bối cảnh, kết quả và bài học nhưng thay thử thách “rivalry in love” bằng
...
tách các thẻ đặc biệt và giữ nguyên nội dung do mô hình sinh.
...
Kho của nhóm chỉ giữ trích đoạn này, không giữ toàn bộ 100 đầu ra sinh từ kho mã nguồn.
...
### 3.2 RQ2a — Ảnh hưởng của dữ liệu và tối ưu hóa
...
### 3.3 RQ2b — Vị trí đặt các tham số thích nghi
...
### 3.4 RQ4 — Đóng góp của lớp kiểm soát khi suy luận
...
### 3.5 Khả năng so sánh giữa các đánh giá nội bộ
...
| E2 · Đào Đức Tùng (20252612M) | vòng sàng lọc 20 trường hợp, Gemma nội bộ + tiêu chí nhân quả | chọn điểm kiểm tra trong chuỗi V16 |
...
## 4. Đánh giá chung và các thí nghiệm phân tích

### 4.1 Thiết lập và trạng thái thực nghiệm

Điểm nội bộ không được nhập vào kết quả thống nhất. Năm mô hình đại diện được nạp trực tiếp
trên cùng máy Apple M4 Pro 24 GiB. Tổng cộng 125 truyện hợp lệ được sinh và chấm trong
vòng đánh giá chung.

### 4.2 Tệp mô hình và môi trường chạy
...
Ở E2, MLX-LM chỉ là backend suy luận cho `runs/v16/artifacts/conditioning-mlx` trong
vòng đánh giá chung. Việc artifact được phục vụ bằng MLX không thay đổi framework đã
dùng để huấn luyện checkpoint V16: phần huấn luyện vẫn chạy bằng PyTorch/Transformers
trên Colab.

E2 dùng đúng định dạng huấn luyện `<char>…</char><moral>…</moral><story>` và chỉ nhận
`character` cùng `teaching`; ba slot `setting`, `challenge` và `outcome` không có kênh biểu diễn trong artifact
này. Bộ chạy chỉ bóc thẻ đặc biệt, không thay moral. E1 sinh phần truyện trực tiếp,
`best_of_n=1`. E4 sinh bằng mô hình nền rồi chạy validator: 5/25 truyện bị viết lại, 19/25 cần
chuẩn hóa dòng moral, tổng cộng 21/25 có ít nhất một hành động. E3 chạy mô hình nền và adapter
...
Tập này không tái dùng `lienntp/data/test_prompts.jsonl`, vì 25 đề của E4 đã được dùng trong
...
Không đầu ra nào được chọn lại sau khi đọc. E1 có hai lần dừng gần như ngay lập tức:
GJ21 rỗng và GJ23 chỉ sinh `)`. Hai vị trí vẫn nằm trong 125 đầu vào chấm; phần truyện có
nội dung của E1 vì vậy là 23/25. Bốn phương án còn lại sinh văn bản ở 25/25 vị trí.

“Cùng đề” nghĩa là mô hình chấm dùng cùng yêu cầu sáu trường. Bộ định dạng chuyển yêu cầu sang
giao diện mà mô hình thực sự hỗ trợ: E1, E3, E4 và E5 nhận prompt năm trường; E2 chỉ nhận character và
teaching vì đó là hợp đồng train của V16. Lượt E2 dùng yêu cầu dạng ngôn ngữ tự nhiên, sai định dạng, được giữ
trong `generations/e1.invalid_prompt.jsonl` nhưng không tham gia bảng cuối.

Thời gian dưới đây là độ trễ sinh trung bình theo từng dòng JSON, không gồm thời
...
### 4.5 Làm mù và hàm chấm điểm

125 cặp được xáo bằng seed `20260726`, đổi thành `B001`–`B125`. Yêu cầu gửi cho mô hình chấm chỉ
...
Mô hình chấm chính là `gemma-4-26b-a4b-it` qua Google GenAI, temperature 0, seed
...
Một lượt chạy thử ban đầu yêu cầu lý do dài cho từng trục đã làm Gemma lặp hoặc cắt ngắn JSON.
...
toàn bộ 125 đầu vào. Lượt compact đầu mất khoảng 5 phút 58 giây theo thời gian tường. Một
lượt chấm khác dùng E2 sai định dạng được giữ tại
`judge_scores.pre_e1_formatter_fix.jsonl` và cũng bị loại. Lượt chính cuối chạy lại đủ
125 đầu vào, lưu ở `judge_scores.blinded.jsonl`, trong khoảng 4 phút 19 giây. Có các cửa
sổ chờ quota 16.000 input token/phút; độ trễ API trung bình 1,66 giây/truyện, không
tính thời gian chờ quota.

### 4.6 Kết quả định lượng

Điểm tổng của một truyện là trung bình bốn trục; điểm của phương án là trung bình 25 truyện,
...
Khoảng tin cậy trên là bootstrap 10.000 lần theo 25 đề. So sánh bắt cặp dùng điểm tổng
trên cùng đề:
...
E5, E4 sử dụng cùng quy mô nền 3B nhưng bổ sung validator, viết lại có điều kiện và chuẩn
...
Mô hình chấm không sinh phần giải thích trong lượt chính; chưa có kiểm tra thủ công bắt cặp hoặc kiểm
...
thước mô hình và chi phí suy luận.

### 4.9 Thí nghiệm phân tích không huấn luyện lại
...
E1 và E5 được sinh lại trên cùng 25 đề, cùng seed và decoding, một lần với đủ năm trường
và một lần chỉ có `character + teaching`. Lượt đủ năm trường tái dùng đầu ra global đã
khóa; lượt hai trường là 50 đầu ra mới. Mô hình chấm riêng năm biến coverage dạng boolean,
...
**Đánh giá phản thực (counterfactual).** Mỗi cặp giữ nguyên setting, challenge, các trường còn
lại và seed; chỉ thay một điều kiện để kiểm tra đầu ra có đổi đúng hướng hay không.
Mười cặp gồm năm cặp thay trait và năm cặp thay outcome. Mô hình chấm liệu mỗi truyện có
...
**E4 trước và sau repair.** Cùng 25 truyện được làm mù và chấm độc lập ở bản thô và
...
Repair chủ yếu bảo đảm định dạng đầu ra và tính đúng của bài học. Tỷ lệ
trait→choice→outcome đã cao ở truyện thô và không thay đổi sau repair; do đó năng lực
này không được quy cho hậu xử lý.

## 5. Thảo luận

### 5.1 Tổng hợp các phát hiện
...
Đánh giá phản thực cung cấp bằng chứng mạnh hơn việc kiểm tra từ khóa: khi chỉ thay
...
ở bản thô và không đổi sau repair. Vì vậy cần báo cáo riêng năng lực sinh của checkpoint,
độ tin cậy của quy trình và chi phí gọi mô hình bổ sung.

### 5.2 Hàm ý cho việc lựa chọn hệ thống
...
validator/repair; E5 phù hợp khi cần một mô hình đơn, không có lượt repair bổ sung.

Lựa chọn giữa hai hệ thống phụ thuộc vào mục tiêu triển khai, không chỉ điểm trung bình:
...
### 5.3 Các yếu tố đe dọa tính hợp lệ

**Tính hợp lệ nội tại.** E4 được phép gọi mô hình lần thứ hai ở 5/25 đề; do đó phép so
sánh không giữ cố định chi phí suy luận. Năm hệ thống đại diện cũng khác về tokenizer,
kích thước và dữ liệu tiền huấn luyện, nên kết quả không cô lập hiệu ứng của một biến
duy nhất.

**Tính hợp lệ của phép đo.** Điểm chính đến từ một Gemma judge không sinh phần giải thích.
...
hay không. E5 đạt đồng thời độ phủ cao, độ nhất quán nhân quả cao và độ nhạy phản thực
...
chất lượng bản thô, hiệu ứng repair và chi phí suy luận, thay vì quy toàn bộ điểm cuối
cho checkpoint.

Các kết luận trên giới hạn ở 25 đề, một seed và một LLM giám khảo. Đánh giá tiếp theo
cần mở rộng tập phản thực, dùng nhiều seed, bổ sung chấm mù của con người và kiểm tra
liên giám khảo; trọng tâm là xác nhận độ nhạy có hướng đối với điều kiện, không phải tìm
một ngưỡng tham số phổ quát.

## 7. Khả năng tái lập và đóng góp của các thành viên

### 7.1 Phân công thực hiện thí nghiệm
...
Nhóm cùng thực hiện giao thức đánh giá thống nhất, các thí nghiệm loại trừ và tổng hợp kết
...
### 7.2 Tệp mô hình và khả năng tái lập
...
Ứng dụng chung đọc mô hình từ `config/models.json`. Bộ chạy chung nạp mô hình trực tiếp
để loại phụ thuộc vào trạng thái Ollama cục bộ. `summary.json` lưu model digest, cấu hình
sinh, mô hình chấm, seed làm mù và thống kê; năm tệp generation JSONL cùng
`judge_scores.blinded.jsonl` là nguồn thẩm quyền của bảng xếp hạng trên.
`run_manifest.json` lưu phiên bản của đề, đầu ra, kết quả chấm và bộ chạy.
